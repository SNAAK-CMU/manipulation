...
snaak_manipulation__action__FollowTrajectory_Goal__create()
{
  ...
  snaak_manipulation__action__FollowTrajectory_Goal * msg = (snaak_manipulation__action__FollowTrajectory_Goal *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_Goal));
  bool success = snaak_manipulation__action__FollowTrajectory_Goal__init(msg);
  if (!success) {
...
snaak_manipulation__action__FollowTrajectory_Goal__destroy(snaak_manipulation__action__FollowTrajectory_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    snaak_manipulation__action__FollowTrajectory_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_Goal__Sequence__init(snaak_manipulation__action__FollowTrajectory_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Goal * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_Goal *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_Goal__fini(&data[i - 1]);
      }
...
snaak_manipulation__action__FollowTrajectory_Goal__Sequence__fini(snaak_manipulation__action__FollowTrajectory_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Goal__Sequence * array = (snaak_manipulation__action__FollowTrajectory_Goal__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_Goal__Sequence__init(array, size);
  if (!success) {
...
snaak_manipulation__action__FollowTrajectory_Goal__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_Goal__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_Goal__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_Goal * data =
      (snaak_manipulation__action__FollowTrajectory_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_Goal__copy(
...
snaak_manipulation__action__FollowTrajectory_Result__init(snaak_manipulation__action__FollowTrajectory_Result * msg)
{
  ...
  if (!geometry_msgs__msg__Transform__init(&msg->end_pose)) {
    snaak_manipulation__action__FollowTrajectory_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Result * msg = (snaak_manipulation__action__FollowTrajectory_Result *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_Result));
  bool success = snaak_manipulation__action__FollowTrajectory_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_Result__Sequence__init(snaak_manipulation__action__FollowTrajectory_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Result * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_Result *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_Result__Sequence__fini(snaak_manipulation__action__FollowTrajectory_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Result__Sequence * array = (snaak_manipulation__action__FollowTrajectory_Result__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_Result__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_Result__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_Result__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_Result * data =
      (snaak_manipulation__action__FollowTrajectory_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Feedback * msg = (snaak_manipulation__action__FollowTrajectory_Feedback *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_Feedback));
  bool success = snaak_manipulation__action__FollowTrajectory_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_Feedback__destroy(snaak_manipulation__action__FollowTrajectory_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    snaak_manipulation__action__FollowTrajectory_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_Feedback__Sequence__init(snaak_manipulation__action__FollowTrajectory_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Feedback * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_Feedback *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_Feedback__Sequence__fini(snaak_manipulation__action__FollowTrajectory_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_Feedback__Sequence * array = (snaak_manipulation__action__FollowTrajectory_Feedback__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_Feedback__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_Feedback__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_Feedback__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_Feedback * data =
      (snaak_manipulation__action__FollowTrajectory_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Request__init(snaak_manipulation__action__FollowTrajectory_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    snaak_manipulation__action__FollowTrajectory_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!snaak_manipulation__action__FollowTrajectory_Goal__init(&msg->goal)) {
    snaak_manipulation__action__FollowTrajectory_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Request__fini(snaak_manipulation__action__FollowTrajectory_SendGoal_Request * msg)
{
  ...
  // goal
  snaak_manipulation__action__FollowTrajectory_Goal__fini(&msg->goal);
}
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Request__are_equal(const snaak_manipulation__action__FollowTrajectory_SendGoal_Request * lhs, const snaak_manipulation__action__FollowTrajectory_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!snaak_manipulation__action__FollowTrajectory_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_SendGoal_Request * msg = (snaak_manipulation__action__FollowTrajectory_SendGoal_Request *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Request));
  bool success = snaak_manipulation__action__FollowTrajectory_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence__init(snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_SendGoal_Request * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_SendGoal_Request *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence__fini(snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence * array = (snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_SendGoal_Request * data =
      (snaak_manipulation__action__FollowTrajectory_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Response__init(snaak_manipulation__action__FollowTrajectory_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    snaak_manipulation__action__FollowTrajectory_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_SendGoal_Response * msg = (snaak_manipulation__action__FollowTrajectory_SendGoal_Response *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Response));
  bool success = snaak_manipulation__action__FollowTrajectory_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence__init(snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_SendGoal_Response * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_SendGoal_Response *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence__fini(snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence * array = (snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_SendGoal_Response * data =
      (snaak_manipulation__action__FollowTrajectory_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Request__init(snaak_manipulation__action__FollowTrajectory_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    snaak_manipulation__action__FollowTrajectory_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_GetResult_Request * msg = (snaak_manipulation__action__FollowTrajectory_GetResult_Request *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Request));
  bool success = snaak_manipulation__action__FollowTrajectory_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence__init(snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_GetResult_Request * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_GetResult_Request *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence__fini(snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence * array = (snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_GetResult_Request * data =
      (snaak_manipulation__action__FollowTrajectory_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Response__init(snaak_manipulation__action__FollowTrajectory_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!snaak_manipulation__action__FollowTrajectory_Result__init(&msg->result)) {
    snaak_manipulation__action__FollowTrajectory_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
snaak_manipulation__action__FollowTrajectory_GetResult_Response__fini(snaak_manipulation__action__FollowTrajectory_GetResult_Response * msg)
{
  ...
  // status
  // result
  snaak_manipulation__action__FollowTrajectory_Result__fini(&msg->result);
}
...
snaak_manipulation__action__FollowTrajectory_GetResult_Response__are_equal(const snaak_manipulation__action__FollowTrajectory_GetResult_Response * lhs, const snaak_manipulation__action__FollowTrajectory_GetResult_Response * rhs)
{
  ...
  // result
  if (!snaak_manipulation__action__FollowTrajectory_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_GetResult_Response * msg = (snaak_manipulation__action__FollowTrajectory_GetResult_Response *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Response));
  bool success = snaak_manipulation__action__FollowTrajectory_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence__init(snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_GetResult_Response * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_GetResult_Response *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence__fini(snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence * array = (snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_GetResult_Response * data =
      (snaak_manipulation__action__FollowTrajectory_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_FeedbackMessage__init(snaak_manipulation__action__FollowTrajectory_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    snaak_manipulation__action__FollowTrajectory_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!snaak_manipulation__action__FollowTrajectory_Feedback__init(&msg->feedback)) {
    snaak_manipulation__action__FollowTrajectory_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
snaak_manipulation__action__FollowTrajectory_FeedbackMessage__fini(snaak_manipulation__action__FollowTrajectory_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  snaak_manipulation__action__FollowTrajectory_Feedback__fini(&msg->feedback);
}
...
snaak_manipulation__action__FollowTrajectory_FeedbackMessage__are_equal(const snaak_manipulation__action__FollowTrajectory_FeedbackMessage * lhs, const snaak_manipulation__action__FollowTrajectory_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!snaak_manipulation__action__FollowTrajectory_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_FeedbackMessage * msg = (snaak_manipulation__action__FollowTrajectory_FeedbackMessage *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(snaak_manipulation__action__FollowTrajectory_FeedbackMessage));
  bool success = snaak_manipulation__action__FollowTrajectory_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence__init(snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_FeedbackMessage * data = NULL;

  if (size) {
    data = (snaak_manipulation__action__FollowTrajectory_FeedbackMessage *)allocator.zero_allocate(size, sizeof(snaak_manipulation__action__FollowTrajectory_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = snaak_manipulation__action__FollowTrajectory_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        snaak_manipulation__action__FollowTrajectory_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence__fini(snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      snaak_manipulation__action__FollowTrajectory_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence * array = (snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence *)allocator.allocate(sizeof(snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence__destroy(snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence__are_equal(const snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence * lhs, const snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  snaak_manipulation__action__FollowTrajectory_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(snaak_manipulation__action__FollowTrajectory_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    snaak_manipulation__action__FollowTrajectory_FeedbackMessage * data =
      (snaak_manipulation__action__FollowTrajectory_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!snaak_manipulation__action__FollowTrajectory_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          snaak_manipulation__action__FollowTrajectory_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!snaak_manipulation__action__FollowTrajectory_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
