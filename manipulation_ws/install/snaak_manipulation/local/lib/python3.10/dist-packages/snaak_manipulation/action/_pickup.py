    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'snaak_manipulation.action.Pickup_Goal')
            logger.debug(
...
class Metaclass_Pickup_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'snaak_manipulation.action.Pickup_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Pickup_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'snaak_manipulation.action.Pickup_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Pickup_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from snaak_manipulation.action import Pickup
...
class Pickup_SendGoal_Request(metaclass=Metaclass_Pickup_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'snaak_manipulation/Pickup_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['snaak_manipulation', 'action'], 'Pickup_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from snaak_manipulation.action._pickup import Pickup_Goal
...
class Metaclass_Pickup_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'snaak_manipulation.action.Pickup_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from snaak_manipulation.action import _pickup
...
class Pickup_SendGoal(metaclass=Metaclass_Pickup_SendGoal):
    from snaak_manipulation.action._pickup import Pickup_SendGoal_Request as Request
    from snaak_manipulation.action._pickup import Pickup_SendGoal_Response as Response
...
class Pickup_GetResult_Response(metaclass=Metaclass_Pickup_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'snaak_manipulation/Pickup_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['snaak_manipulation', 'action'], 'Pickup_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from snaak_manipulation.action._pickup import Pickup_Result
...
class Metaclass_Pickup_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'snaak_manipulation.action.Pickup_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Pickup_GetResult(metaclass=Metaclass_Pickup_GetResult):
    from snaak_manipulation.action._pickup import Pickup_GetResult_Request as Request
    from snaak_manipulation.action._pickup import Pickup_GetResult_Response as Response
...
class Metaclass_Pickup_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'snaak_manipulation.action.Pickup_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Pickup_FeedbackMessage(metaclass=Metaclass_Pickup_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'snaak_manipulation/Pickup_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['snaak_manipulation', 'action'], 'Pickup_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from snaak_manipulation.action._pickup import Pickup_Feedback
...
class Metaclass_Pickup(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'snaak_manipulation.action.Pickup')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Pickup(metaclass=Metaclass_Pickup):
    ...
    from snaak_manipulation.action._pickup import Pickup_Goal as Goal
    # The result message defined in the action definition.
    from snaak_manipulation.action._pickup import Pickup_Result as Result
    # The feedback message defined in the action definition.
    from snaak_manipulation.action._pickup import Pickup_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from snaak_manipulation.action._pickup import Pickup_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from snaak_manipulation.action._pickup import Pickup_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from snaak_manipulation.action._pickup import Pickup_FeedbackMessage as FeedbackMessage
